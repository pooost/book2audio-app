...
def run_openocr(input_path: Path, output_dir: Path | None = None, allow_download: bool = True) -> str:
    ...
    if output_dir is None:
        with tempfile.TemporaryDirectory() as tmpdir:
            return _run_into(openocr_bin, input_path, Path(tmpdir), allow_download)
    return _run_into(openocr_bin, input_path, output_dir, allow_download)


def _run_into(openocr_bin: str, input_path: Path, output_dir: Path, allow_download: bool) -> str:
